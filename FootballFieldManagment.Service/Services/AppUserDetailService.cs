...
{
    public class AppUserDetailService : GenericService<AppUserDetail>, IAppUserDetailService
    {
        public AppUserDetailService(IUnitOfWork unitOfWork, IGenericRepository<AppUserDetail> repository) : base(unitOfWork, repository)
        {
        }
    }
}
