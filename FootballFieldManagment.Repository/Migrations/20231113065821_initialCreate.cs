        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SessionAdminID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PerTeamPlayerCount = table.Column<int>(type: "int", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SessionType = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlayerDetailID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlayerID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssistsCount = table.Column<int>(type: "int", nullable: false),
                    GoalsCount = table.Column<int>(type: "int", nullable: false),
                    CleanSheetCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerDetail", x => x.PlayerDetailID);
                    table.ForeignKey(
                        name: "FK_PlayerDetail_Players_PlayerID",
                        column: x => x.PlayerID,
